 ...
 */
 ...
 $(function(){
     ...
     var pickerhtml = '<div class="tpicker"><div class="pk1"><div class="row"><div class="hr"><ion-icon class="hrup" name="caret-up-outline"></ion-icon><a class="hrhere">12</a><ion-icon class="hrdown" name="caret-down-outline"></ion-icon></div><div class="dot2">:</div><div class="hr"><ion-icon class="minup" name="caret-up-outline"></ion-icon><a class="minhere">00</a><ion-icon class="mindown" name="caret-down-outline"></ion-icon></div><div class="dot"><button type="button" class="btn btn-primary medchange">AM</button></div></div></div><div class="pk2 mintt"><table class="table table-bordered mintable"><tr><td>00</td><td>05</td><td>10</td><td>15</td></tr><tr><td>20</td><td>25</td><td>30</td><td>35</td></tr><tr><td>40</td><td>45</td><td>50</td><td>55</td></tr></table></div><div class="pk2 hrtt"><table class="table table-bordered hrtable"><tr><td>01</td><td>02</td><td>03</td><td>04</td></tr><tr><td>05</td><td>06</td><td>07</td><td>08</td></tr><tr><td>09</td><td>10</td><td>11</td><td>12</td></tr></table></div></div>';
